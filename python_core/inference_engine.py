...
class InferenceEngine:
    ...
    def load(
        ...
        self._model_classes, self.img_size = read_model_meta(
        ...
        if backend == "onnx":
            ...
            self.model = self._build_model(len(self._model_classes))
            if pt_path and Path(pt_path).exists():
        ...
        self.transform = build_torchvision_eval_transform(self.img_size)
    ...
    def predict_batch_images(
        ...
        与 predict_batch(路径) 共用：self.transform、self._model_classes、
